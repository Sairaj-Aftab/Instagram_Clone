    ...
    <div className="post-section">
      <div className="single-post">
        ...
        <div className="post-bottom">
          ...
          <div className="like-count">21,272 likes</div>
          <div className="des-username">
            <span>sairaj_aftab</span>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Voluptatem vitae maxime sint aliquam impedit! Soluta nisi animi
              harum vitae dignissimos?
            </p>
          </div>
          <div className="view-comments">View all 905 comments</div>
          <div className="post-timing">1 day ago</div>
        </div>
